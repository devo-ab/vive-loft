        ...
        solutions."
          ...
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            <img
              ...
              alt="feature image 2"
            />
            <ToolsCard title="We invest in the world’s potential" description="Deliver great service experiences fast - without the complexity of traditional ITSM solutions. Accelerate critical development work, eliminate toil, and deploy changes with ease." list={[
                "Dynamic reports and dashboards",
                "Templates for everyone",
                "Development workflow",
                "Limitless business automation",
                "Knowledge management",
              ]} para="Deliver great service experiences fast - without the complexity of traditional ITSM solutions."></ToolsCard>
          </div>
          {/* invest card start */}
        </div>
      </section>
